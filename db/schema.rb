...
ActiveRecord::Schema.define(version: 2022_12_15_090046) do
  ...
  create_table "dangerous_spots", force: :cascade do |t|
    t.string "address"
    t.text "content"
    t.float "latitude"
    t.float "longitude"
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.bigint "dangerous_spot_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["dangerous_spot_id"], name: "index_favorites_on_dangerous_spot_id"
  ...
  create_table "labellings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["dangerous_spot_id"], name: "index_labellings_on_dangerous_spot_id"
